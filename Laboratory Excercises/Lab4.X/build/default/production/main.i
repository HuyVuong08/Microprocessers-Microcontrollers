...
int timer_var = 10;
int index = 0;
struct callback_member list[10];
...
void __attribute__((picinterrupt(("")))) process(void);
...
void main(void) {
    ...
    INTCONbits.GIE = 1;
    INTCONbits.PEIE = 1;
    register_timer(100, increaseLED, ((void*)0));
    register_timer(300, setLED, ((void*)0));
    while (1) {
        for (int i = 0; i < 10; i++){
            if (list[i].run_flag) {
...
void set_timer(){
    unsigned long int frequency = 8000000/32;
