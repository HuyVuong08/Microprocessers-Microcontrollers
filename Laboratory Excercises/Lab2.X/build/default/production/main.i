...
void TMR1_ISR() {
    ...
    if (readButtonRA5()) {
        ...
        if (pCountRA5 > 300) {
            ...
            pRA5_3s = 1;
            countRA5_300ms++;
            if (countRA5_300ms >= 10) {
                fastCountUpFlag = 1;
                countRA5_300ms = 0;
            }
        } else if (pCountRA5 > 100) {
            pRA5_3s = 0;
            pRA5_1s = 1;
            countRA5_100ms++;
            if (countRA5_100ms >= 50) {
                normalCountUpFlag = 1;
                countRA5_100ms = 0;
            }
        }
        ...
        if (pCountRB0 > 300) {
            ...
            pRB0_3s = 1;
            countRB0_300ms++;
            if (countRB0_300ms > 10) {
                fastCountDownFlag = 1;
                countRB0_300ms = 0;
            }

        } else if (pCountRB0 > 100) {
            pRB0_3s = 0;
            pRB0_1s = 1;
            countRB0_100ms++;
            if (countRB0_100ms >= 50) {
...
void __attribute__((picinterrupt(("")))) CheckButtonsPress() {
